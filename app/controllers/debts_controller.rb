class DebtsController < ApplicationController
  ...
  def debt_params
    params.require(:debt).permit(:category_id, :sub_category, :name, :is_asset, :account_id, :fix_amount, :schedule, :autopay, :payment_start_date, :schedule_id, schedule_attributes: [:rule])
  end
end
