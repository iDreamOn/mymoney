...
AccountBalance.import([:id, :balance_date, :account_id, :amount, :buffer, :paid, :created_at, :updated_at, :debt_balance_id], [
                        [3, '2015-10-30', 2, '2103.0', '10.0', false, '2015-12-19 21:44:56', '2016-01-21 02:59:24', 5],
                        [4, '2015-10-16', 2, '1864.0', '10.0', false, '2015-12-19 21:44:56', '2016-01-21 02:59:24', 5],
                        [5, '2015-11-06', 2, '1085.0', '10.0', false, '2015-12-19 21:44:56', '2016-01-21 02:59:24', 5],
                        [6, '2015-10-23', 2, '436.0', '10.0', false, '2015-12-19 21:44:56', '2016-01-21 02:59:24', 5],
                        [7, '2015-12-04', 2, '4934.0', '10.0', true, '2015-12-19 21:44:56', '2016-01-21 02:59:24', 2],
                        [8, '2015-12-04', 1, '2000.0', '10.0', true, '2015-12-19 21:44:56', '2016-01-21 02:59:24', 2],
                        [9, '2015-11-28', 1, '1010.0', '10.0', false, '2015-12-19 21:44:56', '2016-01-21 02:59:24', 2],
                        [10, '2015-10-16', 1, '710.0', '10.0', false, '2015-12-19 21:44:56', '2016-01-21 02:59:24', 2],
                        [11, '2015-11-06', 1, '80.0', '10.0', false, '2015-12-19 21:44:56', '2016-01-21 02:59:24', 2],
                        [18, '2015-12-31', 2, '2130.0', '10.0', false, '2015-12-23 05:38:55', '2016-01-21 02:59:24', 16],
                        [19, '2016-01-01', 5, '1250.0', '10.0', false, '2015-12-25 09:03:00', '2016-01-21 02:59:24', 16],
                        [20, '2016-01-01', 1, '3524.0', '10.0', false, '2015-12-26 06:10:12', '2016-01-21 02:59:24', 2]
                      ])
...
Schedule.import([:id, :rule], [
                  [1, '{"validations":{"day":[5]},"rule_type":"IceCube::WeeklyRule","interval":1,"week_start":0}'],
                  [2, '{"validations":{"day":[4]},"rule_type":"IceCube::WeeklyRule","interval":2,"week_start":0}']
                ])
IncomeSource.import([:id, :name, :schedule_id, :amount, :start_date, :end_date, :created_at, :updated_at, :account_id], [
                      [2, 'Job 2', 1, '100.0', '2015-10-01', '2015-12-31', '2015-12-13 22:10:29', '2016-01-21 02:59:24', 1],
                      [3, 'Job 1', 1, '2015-01-01', '2015-12-31', '2015-12-14 00:41:21', '2016-01-21 02:59:24', 1],
                      [4, 'Job 3b', 2, '150.0', '2015-12-04', '2016-01-01', '2015-12-25 07:01:55', '2016-01-21 02:59:24', 5]
                    ])
